...
export class TranslationService {
  ...
  private translations: Translations = {
    ar: {
      ...
      doctors_section: {
        ...
        hero_title: 'صحتك في أيدٍ من أطباء بخبرة ومعايير عالمية',
 ...
 en: {
  ...
  hero_title: 'Your health is in the hands of doctors with global standards and expertise.',
