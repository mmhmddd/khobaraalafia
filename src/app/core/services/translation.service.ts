  ...
  private translations: Translations = {
    ar: {
      ...
      doctors_section: {
        ...
        hero_title: 'رعاية صحية بمعايير عالمية',
      ...
      media: {
        ...
        stats: [
          ...
          { id: 3, label: 'أطباء أونلاين', suffix: '+' },
      ...
      'partners-section': {
        partners_title: 'نتعاون مع الأفضل لتقديم الأفضل',
      ...
      contact_page: {
        ...
        faq3_answer: 'لدينا تخصصات متعددة مثل الأسنان، الأطفال، العظام، إلخ.',
   ...
   en: {
      ...
      media: {
        ...
        stats: [
          ...
          { id: 3, label: 'Online Doctors', suffix: '+' },
      ...
      'partners-section': {
        partners_title: 'We Collaborate with the Best to Deliver the Best',
