...
export class ContactComponent implements OnInit, AfterViewInit {
  ...
  updateTranslations(): void {
    ...
    this.contactItems[1].details = `${this.getT('phone_1')}<br>${this.getT('phone_2')}<br>${this.getT('phone_3')}`;
    this.contactItems[2].title = this.getT('address_title');
    this.contactItems[2].details = this.getT('address');
    ...
    this.faqs[1].answer = this.getT('contact_page.faq2_answer');
    this.faqs[2].question = this.getT('contact_page.faq3_question');
    this.faqs[2].answer = this.getT('contact_page.faq3_answer');
    this.faqs[3].question = this.getT('contact_page.faq4_question');
    this.faqs[3].answer = this.getT('contact_page.faq4_answer');
  }
